...
import 'package:timesheet_app/Backend/calendar_model.dart';
import 'package:timesheet_app/Backend/db.dart';
...
class _CalendarState extends State<Calendar> {
  ...
  void _onDaySelected(DateTime day, List events, List eve) {
    setState(() {
      _selectedDay = day;
          ...
          IconButton(
              ...
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => ViewCalendar()));
              }),
          SizedBox(width: 80),
